...
class ValidationManager:
    ...
    def validate_geometry_exists(self):
        """
        Checks the evaluated geometry of each object to see if it has vertices.
        This includes geometry generated by modifiers.
        """
        depsgraph = bpy.context.evaluated_depsgraph_get()

        for mesh_object in self.mesh_objects:
            # Get object after modifiers / geometry nodes evaluation
